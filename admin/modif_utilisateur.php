...
if (isset($_POST['r_titre'])) { // par le nom du premier input
    ...
    $pdoCV->exec(" UPDATE t_realisations SET r_titre='$r_titre', r_soustitre='$r_soustitre', r_description='$r_description', r_dates='$r_dates' WHERE id_realisation='$id_realisation'");
                    ...
                    <form  action="modif_realisation.php" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="r_description" id="r_description" value="<?php echo $ligne_realisation['r_description']; ?>">
                            </div>
                            <div class="form-group">
